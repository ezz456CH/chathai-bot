...
module.exports = {
    ...
    async execute(interaction) {
        ...
        let callsign = data.ac[0].flight != null ? data.ac[0].flight.trim() : data.ac[0].hex.toUpperCase();
        let callsign2 = data.ac[0].flight != null ? data.ac[0].flight.trim() : "No callsign";

        let hex2 = data.ac[0].hex != null ? data.ac[0].hex.toUpperCase() : "n/a";
